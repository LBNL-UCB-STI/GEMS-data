...
#-------------------------------------------------------------------------------
## Set directories
auxdatdir <- "C:/data/CATTLab_delivery/AuxiliaryData"
rdatdir <-"C:/data/CATTLab_delivery/National/proc_data/partition_input" ## Where you put your partition results
...
## Load densities
density_est <- read.csv(file.path(rdatdir, "density_estimation_2010.csv"))
